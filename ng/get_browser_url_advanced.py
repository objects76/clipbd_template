...
def get_chrome_current_url() -> str | None:
...
def get_firefox_current_url() -> str | None:
...
def detect_browser_type() -> str | None:
    ...
    if "chrome" in process_name or "chromium" in process_name:
        return "chrome"
    if "brave" in process_name:
        return "brave"
    if "opera" in process_name:
        return "opera"
    if "edge" in process_name:
        return "edge"

    return None


def get_url_browser_specific() -> str | None:
...
def get_current_browser_url_advanced() -> str | None:
    """
